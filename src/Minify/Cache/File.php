 ...
 * @package Minify
 */
namespace JYmusic\Assets\Minify\Cache;


use JYmusic\Assets\Minify\Logger;
...
class File {
    ...
    public function store($id, $data)
    {
        ...
        if (! @file_put_contents($file, $data, $flag)) {
            $this->_log("Minify\Cache\File: Write failed to '$file'");
        }
        // write control
        if ($data !== $this->fetch($id)) {
            @unlink($file);
            $this->_log("Minify\Cache\File: Post-write read failed for '$file'");
            return false;
        }
        return true;
    }
