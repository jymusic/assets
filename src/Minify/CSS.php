...
use JYmusic\Assets\Minify\CSS\Compressor;
use JYmusic\Assets\Minify\CSS\UriRewriter;
use JYmusic\Assets\Minify\CommentPreserver;
        ...
        if ($options['compress']) {
            if (! $options['preserveComments']) {
                ...
                $css = CommentPreserver::process(
                    $css
                    ,array('Minify\CSS\Compressor', 'process')
                    ,array($options)
                );
            }
        }
